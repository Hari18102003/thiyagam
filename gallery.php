...
$sql = "SELECT id, title, name, date FROM Gallery ORDER BY id DESC";
...
<body>
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="header">
                <h2>Gallery List</h2>
                <button><a href="add-gallery.html">Add Gallery</a></button>
            </div>
            <table>
                <tr>
                    <th>Title</th>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>{$row['date']}</td>
                                <td>
                                    <a href='add-gallery.html?id={$row['id']}' class='btn edit-btn'>Edit</a>
                                    <a href='admin/gallery-delete.php?id={$row['id']}' class='btn delete-btn' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a>
                                </td>
                              </tr>";
                    }
                } else {
