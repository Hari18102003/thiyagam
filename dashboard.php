...
$sql = "SELECT id, title, name, date FROM Media ORDER BY id DESC";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>
                                    ...
                                    <a href='admin/media-delete.php?id={$row['id']}' class='btn delete-btn' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a>
                                </td>
                              </tr>";
                    }
                } else {
